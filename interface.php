...
<head>
	...
	<style type="text/css">
		...
		*/
		...
		.myTable{position:absolute;top:90px;left:850px; height:50px;width:400px;overflow-y:scroll;border-bottom:2px solid black;}
		...
		.dish{position:relative; top:140px; left:870px; font-size:25px; border-bottom:1px solid black;}
		.price{position:relative;  top:140px; left:1000px; font-size:25px;border-bottom:1px solid black;}
		.addbtn{position:relative; top:140px; left:1100px; font-size:20px; padding:8.5px;}

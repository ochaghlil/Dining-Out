...
<head>
	...
	<style type="text/css">
		...
		*/
		...
		.dish{position:relative; top:160px; left:870px; font-size:25px; border-bottom:1px solid black;}
		.price{position:relative;  top:160px; left:1000px; font-size:25px;border-bottom:1px solid black;}
